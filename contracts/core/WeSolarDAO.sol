...
/**
 * @title WeSolarDAO
 * @notice Community governance for the WeSolar platform.
 *         WST token holders vote on:
 *         - New solar installation approvals
 *         - Energy credit allocation policies
 *         - Platform fee structures
 *         - Expansion into new neighborhoods
 *         - Grant fund allocation
 *
 * @dev OpenZeppelin Governor v5 implementation.
 *      Part of The Elevation Foundation ecosystem (EIN 92-1042348).
 *      Designed for Celo Climate Collective grant application.
 */
contract WeSolarDAO is
    Governor,
    GovernorSettings,
